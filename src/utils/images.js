...
import eclipse from '../assets/images/Eclipse_Lunar.png'

// slider images import and then exported
const sliderImages = [eclipse, slider_img_1, slider_img_2, slider_img_3, slider_img_4, eclipse,slider_img_5, slider_img_6, slider_img_7 ];

// all images 
export { banner_image, sliderImages, join_image, game_details_image, loader, store_image, eclipse };